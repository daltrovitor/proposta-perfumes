...
O **NXTGEN** é concebido como um ecossistema digital jovem para as Gerações Alpha e Z (*"The Future Pays More / Build. Don't Bet"*), integrando benefícios, banking, eventos presenciais, investimentos e bem-estar em um ambiente único e modular.
...
| :---: | :--- | :---: |
| **Fase 1** | **NXT PASS** (Clube de Benefícios, Vouchers QR, Orquestrador de Pagamentos, Split & Painel) | **R$ 4.000,00** |
| **Fase 2** | **NXT BANK** (Banco Digital BaaS, Saldo, Extrato, Pix In/Out, Cartões & Carteira) | **R$ 5.500,00** |
| **Fase 3** | **NXT LIVE** (Eventos, NXT UP Ingressos, NXT RUN Corridas, Validador Portaria & Founders) | **R$ 6.500,00** |
| **Fase 4** | **NXT INVEST** (Plataforma de Investimentos Corretora, Esteira KYC/AML, Suitability & Carteiras) | **R$ 7.500,00** |
| **Fase 5** | **NXT ME** (Saúde Mental, Psicólogos, LGPD Sensível, Mentoria Molina & Conexões Circle) | **R$ 9.000,00** |
| **TOTAL** | **Ecossistema Completo NXTGEN (5 Fases)** | **R$ 32.500,00** |

```
Distribuição Financeira por Fase:
Fase 1 (NXT PASS):    [====] R$ 4.000,00 (12,3%)
Fase 2 (NXT BANK):    [=====] R$ 5.500,00 (16,9%)
Fase 3 (NXT LIVE):    [======] R$ 6.500,00 (20,0%)
Fase 4 (NXT INVEST):  [=======] R$ 7.500,00 (23,1%)
Fase 5 (NXT ME):      [=========] R$ 9.000,00 (27,7%)
                      ------------------------------------
...
```mermaid
graph LR
    F1[Fase 1: NXT PASS<br>R$ 4.000] --> F2[Fase 2: NXT BANK<br>R$ 5.500]
    F2 --> F3[Fase 3: NXT LIVE<br>R$ 6.500]
    F3 --> F4[Fase 4: NXT INVEST<br>R$ 7.500]
    F4 --> F5[Fase 5: NXT ME<br>R$ 9.000]
```

### Fase 1: NXT PASS — Clube de Benefícios & Fundação
...
### Fase 2: NXT BANK — Banco Digital & Experiência BaaS
...
- **NXT RUN (Módulo de Corridas de Rua):**
...
### Fase 4: NXT INVEST — Plataforma de Investimentos
...
### Fase 5: NXT ME — Saúde Emocional, Mentoria & Conexões
**Investimento:** **R$ 9.000,00**

- **NXT ME (Saúde Emocional & Psicologia):**
...
- **NXT LEVEL (Mentoria de Rafael Molina):**
...
- **NXT CIRCLE (Conexões Humanas "Unplug"):**
...
1. **Fase 1 — NXT PASS:** R$ 4.000,00 *(50% no início da fase e 50% na homologação)*
2. **Fase 2 — NXT BANK:** R$ 5.500,00 *(50% no início da fase e 50% na homologação)*
3. **Fase 3 — NXT LIVE:** R$ 6.500,00 *(50% no início da fase e 50% na homologação)*
4. **Fase 4 — NXT INVEST:** R$ 7.500,00 *(50% no início da fase e 50% na homologação)*
5. **Fase 5 — NXT ME:** R$ 9.000,00 *(50% no início da fase e 50% na homologação)*
...
| :---: | :--- | :---: | :--- |
| **1** | **NXT PASS** | **R$ 4.000** | Core App, Auth, Marketplace de Benefícios, QR Code dinâmico anti-screenshot, Payment Orchestrator multi-PSP, Split automático e Painel do Parceiro. |
| **2** | **NXT BANK** | **R$ 5.500** | Integração BaaS, Conta Digital, Saldo em tempo real, Extrato, Pix (Chaves/QR/Copia-e-Cola), Cartão Virtual/Físico e Carteira Unificada. |
| **3** | **NXT LIVE** | **R$ 6.500** | Catálogo de Eventos, Compra de Ingressos NXT UP, App de Validação de Portaria, Inscrições e Kits NXT RUN e Funil de Startups NXT FOUNDERS. |
| **4** | **NXT INVEST**| **R$ 7.500** | Conexão com Corretora CVM, Esteira KYC/AML, Questionário de Suitability, Vitrine de Fundos/Renda Fixa/Ações e Posição Patrimonial. |
| **5** | **NXT ME** | **R$ 9.000** | Agendamento de Psicólogos com blindagem LGPD, Mentoria Rafael Molina com Pitch 60s (NXT LEVEL) e Rede Social sem fotos por propósito (NXT CIRCLE). |
| **TOTAL**| **5 FASES** | **R$ 32.500** | **Ecossistema Completo NXTGEN Entregue e Homologado** |
